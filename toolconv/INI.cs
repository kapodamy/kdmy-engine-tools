...
namespace Settings
{
    internal class INI
    {
        ...
        internal double GetDouble(string section, string key, double @default = 0)
        {
            string value = GetString(section, key);
            if (value == null)
                return @default;
        ...
        internal void SetDouble(string section, string key, double value)
        {
            SetString(section, key, value.ToString(CultureInfo.InvariantCulture));
        }
        ...
        internal IEnumerable<string> IterateSections()
        {
            foreach (Section section in sections)
            {
        ...
        internal IEnumerable<string> IterateKeys(string section)
        {
            Section list = GetSection(section, false);
